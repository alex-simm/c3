...
def generate_couplings(Num_qubits, Num_coupler, NN_coupling_strength, NNN_coupling_strength, qubit_array, coupler_array):
    ...
    for i in range(Num_coupler + Num_qubits - 1):
        ...
        g_NN_array.append(
            chip.Coupling(
                name=qubit_array[qubit_index].name + "-" + coupler_array[coupler_index].name,
                desc="Coupling",
                comment="Coupling between "+ qubit_array[qubit_index].name + " and " + coupler_array[coupler_index].name,
                connected=[qubit_array[qubit_index].name, coupler_array[coupler_index].name],
                strength=Qty(
    ...
    for i in range(len(NNN_coupling_strength)):
        g_NNN_array.append(
            chip.Coupling(
                ...
                desc="Coupling",
                comment="Coupling between "+ qubit_array[i].name + " and " + qubit_array[i+1].name,
