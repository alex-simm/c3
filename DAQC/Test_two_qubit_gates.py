...
parameter_map.load_values("best_point_0.07.txt")
...
sequence = ['iswap[0, 1]']
plotPopulation(exp, init_state, sequence, usePlotly=False, filename="Before_opt_iswap.png")
...
plotPopulation(exp, init_state, sequence, usePlotly=False, filename="After_opt_iswap.png")
parameter_map.store_values("Two_qubit_gates.c3log")
